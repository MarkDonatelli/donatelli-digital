...
export default function SectionOne({ logoDone }: { logoDone: boolean }) {
  return (
        ...
        <div className="max-w-6xl mx-auto px-6 space-y-20">
          ...
          >
            ...
            <p className="text-[16px] text-neutral-600 leading-[1.72] max-w-xl">
              When someone lands on your site, they’re trying to understand a few basic
              things: what you do, why it matters, and what to do next. Everything we
              design supports that moment of clarity.
            </p>
          </motion.div>
          ...
          <div className="grid lg:grid-cols-6 gap-20 lg:gap-14">
            ...
            >
              <span className="text-sm text-neutral-500 tracking-wider">01 — Messaging</span>
              ...
              <p className="text-[15px] text-neutral-600 leading-relaxed max-w-[36ch]">
                Simple language that honors the way real people speak. Not buzzwords, not
                over-explanation—just clarity with confidence.
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              className="lg:col-span-2 space-y-4"
            >
              <span className="text-sm text-neutral-500 tracking-wider">02 — Structure</span>
              <h3 className="font-semibold text-[20px] text-accent leading-snug tracking-tight">
                Guide people without them noticing
              </h3>
              <p className="text-[15px] text-neutral-600 leading-relaxed max-w-[36ch]">
                Information arranged in the same rhythm people make decisions: understanding
                → trust → action.
              </p>
            </motion.div>
            ...
            <motion.div
              ...
              className="lg:col-span-2 space-y-4"
            >
              <span className="text-sm text-neutral-500 tracking-wider">03 — Delivery</span>
              <h3 className="font-semibold text-[20px] text-accent leading-snug tracking-tight">
                Make the whole process feel calm
              </h3>
              <p className="text-[15px] text-neutral-600 leading-relaxed max-w-[36ch]">
                No guesswork, no wondering what’s next. Clear checkpoints, realistic pacing,
