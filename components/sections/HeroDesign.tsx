      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-12 pt-36 md:pt-48">
        ...
        <h1 className="font-playfair text-6xl md:text-8xl lg:text-9xl leading-[0.92] tracking-tight mt-8 font-semibold">
          ...
          <span className="relative inline-block font-semibold">
            velocity.
            <svg className="absolute  w-full h-4 -bottom-2 left-0" viewBox="0 0 200 9">
              <path d="M2 7C52 4 154 -2 198 2" stroke="var(--accent)" strokeWidth="4" />
            </svg>
          </span>
        </h1>

        <p className="mt-10 text-xl md:text-2xl font-light max-w-xl leading-relaxed border-l-2 pl-6 border-accent text-muted">
          We build digital experiences that give brands clarity, confidence and a premium
          presentation. Everything feels organized, intentional and delivered with speed.
        </p>
      </div>
    </section>
  );
